...
public class DBF_Field {
  ...
  public static final int SIZE_BYTES = 32;//ÿ���ֶ�ռ32���ֽ�
  //@SuppressWarnings("unused") ��ʾ�������ڷ���������û��ʹ�á���Ӵ�ע�����ȥ�������ϵĻ�ɫ���棡����
  @SuppressWarnings("unused")
  private DBF_File parent_dbasefile;
  private int index = 0;
  private String DBF_field_name = "";//�ֶ�����
  private char   DBF_field_type        ;//�ֶ�����
  @SuppressWarnings("unused")
  private int    DBF_field_displacement;
  private int    DBF_field_length      ;//�ֶγ���
  @SuppressWarnings("unused")
  ...
  public DBF_Field(DBF_File parent_dbasefile, ByteBuffer bb, int index){
    ...
    this.index = index;//�ֶε�����--���ڼ����ֶ�
    
    // read data
    byte[] string_tmp = new byte[11];  //0-11-�ֶ�����
    bb.get(string_tmp);
    try {
    ...
    DBF_field_type         = (char)bb.get   ();//�ֶ�����
    DBF_field_displacement = bb.getInt();//ϵͳ����
    DBF_field_length       = bb.get   () & 0xFF; // so we get values from 0-255.-�ֶγ���
    DBF_field_flag         = bb.get   ();//С��λ��
