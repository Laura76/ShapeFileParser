...
public class DBF_File extends ShapeFileReader{
  ...
  //HEADER-锟侥硷拷头锟斤拷息锟斤拷
  private byte DBF_file_type;//锟侥硷拷锟斤拷锟酵ｏ拷1锟街斤拷
  private int  DBF_date_yy;
  private int  DBF_date_mm;
  private int  DBF_date_dd;//锟侥硷拷锟斤拷锟斤拷薷锟斤拷锟斤拷锟�
  
  private int  DBF_number_of_records; // number of records.-锟斤拷录锟斤拷锟斤拷
  private int  DBF_size_header_bytes; // size of header (bytes).-锟侥硷拷头锟斤拷锟斤拷
  private int  DBF_size_record_bytes; // size of record (bytes).-锟斤拷录锟斤拷锟斤拷
  
  // FIELDS
  private DBF_Field[] DBF_fields;//锟街讹拷锟斤拷锟介（锟斤拷锟斤拷锟斤拷锟捷匡拷锟叫的憋拷锟斤拷侄危锟�
  
  // RECORD TABLE
  private String[][] DBF_records;//锟斤拷录锟斤拷锟斤拷
  ...
  public void read() throws Exception{
    //--------------------------------------------------------------------------
    // READ HEADER
    bb.order(ByteOrder.LITTLE_ENDIAN);//小锟街斤拷
    DBF_file_type         = bb.get     ( 0);
    DBF_date_yy           = bb.get     ( 1)+1900;
    DBF_date_mm           = bb.get     ( 2);
    DBF_date_dd           = bb.get     ( 3);
    DBF_number_of_records = bb.getInt  ( 4);
    DBF_size_header_bytes = bb.getShort( 8);//锟侥硷拷头锟斤拷锟饺ｏ拷锟侥硷拷头锟斤拷息锟斤拷锟斤拷锟街讹拷锟斤拷锟斤拷锟斤拷锟斤拷
    DBF_size_record_bytes = bb.getShort(10);//一锟斤拷锟斤拷录锟斤拷锟街节筹拷锟斤拷
    ...
    int num_fields = (DBF_size_header_bytes-POS-1 )/DBF_Field.SIZE_BYTES; // cant this be easier???锟街段的革拷锟斤拷
...
//      DBF_fields[i].print();
    ...
    byte DBF_header_terminator = bb.get(); // = 13 or 0x0D--锟街讹拷锟斤拷锟斤拷锟斤拷锟侥斤拷锟斤拷锟斤拷
